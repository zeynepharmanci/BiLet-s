...
public class TiyatroDetayFrame extends JFrame {
    ...
    public TiyatroDetayFrame(String ad, String sehir, double fiyat, String yazar, int perdeSayisi) {
        setTitle("Tiyatro Detayı - " + ad);
        setSize(450, 450);
        
     // ÇOK ÖNEMLİ: EXIT_ON_CLOSE dersen tüm program kapanır. DISPOSE_ON_CLOSE diyerek
        // sağ üstteki X tuşuna basıldığında SADECE bu alt pencerenin kapanmasını sağlıyoruz!
        ...
        pnlBaslik.setBackground(new Color(25, 25, 112));
        
        JLabel lblOyunAdi = new JLabel("🎭 " + ad, SwingConstants.CENTER);
        lblOyunAdi.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblOyunAdi.setForeground(Color.WHITE);
        
        JLabel lblAltBaslik = new JLabel("Tiyatro Oyunu", SwingConstants.CENTER);
        lblAltBaslik.setForeground(Color.LIGHT_GRAY);
        
        pnlBaslik.add(lblOyunAdi);
        ...
        pnlDetay.add(bilgiOlustur("✍️ Yazar:", yazar));
        pnlDetay.add(bilgiOlustur("⏳ Süre:", perdeSayisi + " Perde"));
