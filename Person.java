...
public abstract class Person {
    ...
    public static String girisYap(String girilenEmail, String girilenSifre){
    	for(Person p : VeriDeposu.kullaniciListesi) {
        if (p.email.equals(girilenEmail) && p.password.equals(girilenSifre)) {
            return "Giriş Başarılı! Hoş geldin, ";
        } else {
	...
	public static void uyeOl(Kullanici yeni) {
