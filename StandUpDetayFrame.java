...
public class StandUpDetayFrame extends JFrame {
    ...
    public StandUpDetayFrame(String ad, String sehir, double fiyat, String komedyen, String yasSiniri) {
        setTitle("Stand-Up Detayı - " + ad);
        setSize(450, 450);
        ...
        pnlBaslik.setBackground(new Color(204, 85, 0)); 
        
        JLabel lblGosteriAdi = new JLabel("🎤 " + ad, SwingConstants.CENTER);
        lblGosteriAdi.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblGosteriAdi.setForeground(Color.WHITE);
        
        JLabel lblAltBaslik = new JLabel("Stand-Up Gösterisi", SwingConstants.CENTER);
        lblAltBaslik.setForeground(Color.LIGHT_GRAY);
        
        pnlBaslik.add(lblGosteriAdi);
        ...
        pnlDetay.add(bilgiOlustur("🎙️ Komedyen:", komedyen));

        pnlDetay.add(bilgiOlustur("🔞 Yaş Sınırı:", yasSiniri + " (Kimlik kontrolü yapılabilir)"));
